...
class SubmissionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create submission" do
    assert_difference('Submission.count') do
      post submissions_url, params: { submission: { submitted_date: @submission.submitted_date, survey_id: @submission.survey_id } }
    end
  ...
  test "should update submission" do
    patch submission_url(@submission), params: { submission: { submitted_date: @submission.submitted_date, survey_id: @submission.survey_id } }
